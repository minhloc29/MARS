...
def main():
    ...
    parser.add_argument("--dgl_knn", type=int, default=50)
    parser.add_argument("--dgl_depot_knn", type=int, default=50)
    parser.add_argument("--dgl_pomo_size", type=int, default=4)
