...
class AMSlot(AttentionModel):
    ...
    def __init__(
        ...
        **am_kwargs,
        ...
        # Build base encoder. With disable_slots=True this is used directly
        # (plain AM, no SlotAttention) as a true no-slot baseline.
        ...
        # Auxiliary losses (skipped entirely when slots are disabled)
